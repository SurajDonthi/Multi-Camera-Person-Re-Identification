...
def re_ranking(scores, k1=20, k2=6, lambda_value=0.3):
    # The following naming, e.g. gallery_num, is different from outer scope.
    # Don't care about it.
    num_queries = len(scores)
    original_dist = scores
    ...
    original_dist = original_dist[:num_queries, ]
    if k2 != 1:
    ...
    del V
    del jaccard_dist
    final_dist = final_dist[:num_queries, num_queries:]
    return final_dist
